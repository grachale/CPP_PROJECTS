    ...
    set <size_t> search ( const T_ & word) const
    {
        ...
        for ( ; iIterator != word . end (); )
        {
                 ...
                 !c_Comparer ( (*jIterator), (*iIterator) ) )
            {
                ...
                {
                    jNumber = pi [jNumber - 1];
                    jIterator = word . begin ();
                    for ( int i = 0; i < pi [jNumber - 1]; ++i )
                        jIterator++;
                }
        }
        ...
        for ( ; kIterator != c_Line . end (); )
        {
            ...
            {
                kNumber++; kIterator++;
                if ( kNumber == c_LengthOfLine )
                {
                    return indexes;
                }
            } else
            {
                lNumber = pi [lNumber - 1];
                lIterator = c_Line . begin ();
                for ( int i = 0; i < pi [lNumber - 1]; ++i ){
                    lIterator++;
                }
            }
        }
